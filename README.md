...
Software Engineer with **4+ years of experience** building scalable full-stack applications. Experienced in developing end-to-end solutions using modern frameworks, microservices architecture, and cloud technologies.

---

## Current Focus

- **Built [trolley-today](https://trolleytoday.com)** — a live grocery price comparison app helping Australian shoppers save money across Woolworths, Coles and Aldi and 4 more shops. Developed real-time data pipeline.
- **Built and deployed a LMS [LearnEasy](https://courses.farealahmed.com)** - Demo Student and instructor version added to see the works done here.
- Building AI-powered applications with RAG architecture and vector databases
- Developed scalable video streaming platforms with secure upload and playback capabilities
...
**Tech Stack:** Java, LangChain4j, PostgreSQL (pgvector), Spring Boot

---

### 🎥 [my-video-vault](https://github.com/farealahmed/my-video-vault)
Full-featured video streaming platform with secure upload, storage, and playback capabilities. Implements scalable backend architecture for media handling.
...
**Live:** [nssunshinepsychology.com](https://nssunshinepsychology.com/)

---

## What I'm Looking For

I'm actively seeking **Full-Stack or Backend Engineer** positions where I can:
- Build scalable, high-performance applications
- Work with modern tech stacks (Java/Kotlin, Spring Boot, React, Node.js)
- Contribute to AI/ML integration projects
...
<!---
farealahmed/farealahmed is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
